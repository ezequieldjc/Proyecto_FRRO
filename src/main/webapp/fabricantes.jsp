...
<div class="wrapper" style="font-family: 'Andale Mono', Fallback, sans-serif; overflow-y: hidden;">
    ...
    <div class="content" id="contenido">
        ...
        <div class="main text-center" style="overflow-y: scroll;">
            <h1 style="margin-bottom: 3%">Productos - Listado de Fabricantes</h1>
            <%
                String id="";
                String perfil="";
                String estado="";
                ...
                <div class="row col-sm-12 justify-content-center" >
                    ...
                    <div class="input-group col-sm-2" style="margin-left: 3%;">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputCodFab">Cod</label>
                        </div>
                        <input type="text" class="form-control" placeholder="all" name="inputCodFab" id="inputCodFab" >
                    </div>
                    <div class="input-group col-sm-2">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputNombreFab">Nombre</label>
                        </div>
                        <input type="text" class="form-control" placeholder="all" name="inputNombreFab" id="inputNombreFab" >
                    </div>
                    <div class="input-group col-sm-2">
                        <div class="input-group-prepend">
                            <label class="input-group-text" for="inputCUIT">CUIT</label>
                        </div>
                        <input type="text" class="form-control" placeholder="all" name="inputCUIT" id="inputCUIT" >
                    </div>
                ...
                <table class="table">
                    ...
                    <%
                        for (ProductoFabricante p : new ProductoFabricantesHandler().getAll()){
                            ...
                            out.print("<td>"+p.getCuit()+"</td>");
                            out.print("<form name=\"usr\" method=\"get\" action=\"fabricanteView.jsp\">");
